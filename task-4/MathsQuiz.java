...
public class MathQuiz extends JFrame {
    ...
    //labels
    JLabel QuestionLabel = new JLabel("Click 'Start' to begin and 'Stop' to view the result");
    JLabel answerLabel = new JLabel("Type the answer & press enter key to move to next question");
    ...
    public MathQuiz() {
        ...
        panel211.setLayout(new FlowLayout(FlowLayout.CENTER)); /* Gridlerin içini flow yaptýk. Çünki */
        panel212.setLayout(new FlowLayout(FlowLayout.CENTER)); /* label'lar ortalý duruyorlar idi.   */
